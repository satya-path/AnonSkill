...
from src.connections.vectordb_connection import VectorDBConnection
from src.connections.sonicnft_connection import SonicnftConnection
...
class ConnectionManager:
    ...
    def _class_name_to_type(class_name: str) -> Type[BaseConnection]:
        ...
        elif class_name == "vectordb":
            return VectorDBConnection
        elif class_name == "sonicnft":
            return SonicnftConnection
        return None
